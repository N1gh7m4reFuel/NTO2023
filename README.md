...
## ✔️ Using weak hashing algorithms
...
## ✔️ Large string→int conversion DOS attack
...
## ✔️ Inappropriate security options for methods
...
## ✔️ Excessive hints in login errors
